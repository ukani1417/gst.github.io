    ...
    <table class="table">
            <thead>
                <tr>
                    ...
                    <th scope="col">IGST Lliability</th>
                    <th scope="col">CGST Lliability</th>
                    <th scope="col">SGST Lliability</th>
            ...
            <tbody>
                ...
                $query = pg_query($con, "select * from credit_leadger order by credit_leadger");
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $inx['igst_credit']; ?></td>
                        <td><?php echo $inx['cgst_credit']; ?></td>
                        <td><?php echo $inx['sgst_credit']; ?></td>
                        <td><?php echo $inx['igst_liability']; ?></td>
                        <td><?php echo $inx['cgst_liability']; ?></td>
                        <td><?php echo $inx['sgst_liability']; ?></td>
