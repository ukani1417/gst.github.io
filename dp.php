...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <table class="table">
                                ...
                                <tbody>
                                    ...
                                    $query = pg_query($con, "select * from personal_information");


                                    while ($r2 = pg_fetch_assoc($query)) {
                                    ?>
                                        <tr>
                                            <td> <?php echo $r2['first_name'];
                                                                echo " ";
                                                                echo $r2['middle_name'];
                                                                echo " ";
                                                                echo $r2['last_name']; ?> </td>
                                            <td><?php echo date("d-m-Y", strtotime($r2['dob'])); ?></td>
                                            <td><?php echo $r2['aadhar_no']; ?></td>
                                            <td><?php echo $r2['mobile_no'] ?></td>
